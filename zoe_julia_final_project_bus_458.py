# -*- coding: utf-8 -*-
"""Zoe/Julia.Final_Project_BUS_458.ipynb
...
# Multi-dimensional analysis: FICO_score vs. Granted_Loan_Amount by Approved Status and Lender
plt.figure(figsize=(15, 8))
sns.relplot(
    data=df_clean,
    x='FICO_score',
    y='Granted_Loan_Amount',
    hue='Approved',
    col='Lender',
    kind='scatter',
    palette='coolwarm',
...
plt.suptitle('FICO Score vs. Granted Loan Amount by Approval Status across Lenders', y=1.02) # Adjust suptitle position
plt.tight_layout()
plt.show()
...
X_pre_encode = df_model.drop(columns=['Approved', 'bounty'])
...
The Logistic Regression model performed best overall. Although the Decision Tree had higher accuracy, this was mainly because it predicted the majority class, denied, more often. Logistic Regression had a much stronger ROC-AUC, F1-score, and recall, meaning it was better at capturing the target event of loan approval. Since the business goal is to identify likely approvals and improve lender matching, Logistic Regression is the better choice.
"""
